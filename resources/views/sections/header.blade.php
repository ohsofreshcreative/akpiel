...
<header x-data="{ mobileOpen: false }" class="relative top-0 z-50 bg-white masthead fixed-top mt-4 rounded-full">
	...
	<div class="items-center justify-between hidden h-full py-4 md:px-4 lg:px-12 mx-auto lg:flex">
		<div class="flex gap-2 items-center">
			...
			<img class="relative max-w-35 min-w-25" src="/wp-content/uploads/2026/02/evereth-1.svg" />
		</div>
	...
	<div class="flex items-center justify-between p-4 mobile-menu fixed-top lg:hidden gap-2">
			...
			<div class="flex gap-2 items-center">
					...
					<img class="relative max-w-25 min-w-25" src="/wp-content/uploads/2026/02/evereth-1.svg" />
				</div>
			@else
